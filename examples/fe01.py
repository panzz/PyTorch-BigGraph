...
FILENAMES = {
    'train': 'fe01/frontend_mtr100_mte100-train.txt',
    'valid': 'fe01/frontend_mtr100_mte100-valid.txt',
    'test': 'fe01/frontend_mtr100_mte100-test.txt',
}
...
def main():
    parser = argparse.ArgumentParser(description='Example on fe01')
    parser.add_argument('--config', default='configs/fe01_config.py',
    ...
    print('train train_config:{}'.format(train_config))
    train(train_config)
